...
const DICT: Record<string, { en: string; he: string }> = {
  ...
  "gift.publicTotal": { en: "🪙{total} gifted between players so far", he: "🪙{total} ניתנו במתנה בין שחקנים עד כה" },
  ...
  "gift.publicLine": { en: "{sender} gifted {recipient} 🪙{amount}", he: "{sender} נתן/ה ל-{recipient} 🪙{amount}" },
  "gift.none": { en: "No gifts yet", he: "אין מתנות עדיין" },
  "loan.none": { en: "No loans yet", he: "אין הלוואות עדיין" },
  "loan.publicOweLine": { en: "{borrower} owes {lender} 🪙{amount}", he: "{borrower} חייב/ת ל-{lender} 🪙{amount}" },
  "loan.publicRepaidLine": { en: "{borrower} repaid {lender} 🪙{amount}", he: "{borrower} החזיר/ה ל-{lender} 🪙{amount}" },
