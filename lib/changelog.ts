...
export const CHANGELOG: Release[] = [
  ...
  },
  {
    ...
    date: "2026-06-21",
    changes: [
      "🎁 A warm welcome: every player gets a one-time +🪙500 gift for joining and playing — and so will new players when they sign up.",
    ],
  },
  {
    version: "4.1",
    date: "2026-06-21",
    changes: [
      "Fixed a white bar that could flicker at the bottom of the screen while scrolling on phones.",
    ],
  },
  {
    version: "4.0",
    date: "2026-06-20",
    changes: [
      "More reliable sign-in: a brief server hiccup or weak connection no longer logs you out or bounces you after a bet — you stay signed in and it just retries.",
      "You can now use Hebrew (or any language) letters in your username.",
    ],
  },
  {
    version: "3.9",
